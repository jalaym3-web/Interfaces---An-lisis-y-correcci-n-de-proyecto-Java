...
/**
 * Implementa AMBAS interfaces: sabe procesar pago y sabe notificar. Cada
 * interface se cumple de forma distinta según el tipo de pago.
 */
public class PagoConTarjeta implements Pagable, Notificable {
	...
	public boolean procesarPago(double monto) {
		...
		System.out.printf("Pago con tarjeta %s APROBADO por Q%.2f.%n", enmascarar(numeroTarjeta), monto);
		return true;
	}
