 ...
 * <p>
 * 1. Pagable define procesarPago(). 2. Notificable define enviarConfirmacion().
 * 3. PagoConTarjeta y PagoEnEfectivo implementan ambas. 4. Procesamos una lista
 * de Pagable sin saber el tipo real de cada uno.
 */
