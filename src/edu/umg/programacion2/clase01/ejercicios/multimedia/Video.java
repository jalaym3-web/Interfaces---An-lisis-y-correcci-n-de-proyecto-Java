 ...
 * <p>
 * Pista para reproducir(): imprime algo como "Reproduciendo video: <titulo> en
 * <resolucion>". Pista para detener(): imprime algo como "Video detenido:
 * <titulo>".
 */
public class Video implements Reproducible {
	...
	public void reproducir() {
		System.out.println("Reproduciendo video: " + titulo + " Resolución: " + resolucion);
	}
