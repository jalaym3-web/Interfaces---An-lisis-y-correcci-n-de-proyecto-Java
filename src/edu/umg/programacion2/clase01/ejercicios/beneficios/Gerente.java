 ...
 * <p>
 * Regla de negocio: - Bono fijo de Q500, más Q100 adicionales por cada año de
 * servicio. - El parámetro salarioBase NO se usa en esta fórmula (a propósito:
 * no todas las implementaciones de un contrato usan todos sus parámetros).
 * <p>
