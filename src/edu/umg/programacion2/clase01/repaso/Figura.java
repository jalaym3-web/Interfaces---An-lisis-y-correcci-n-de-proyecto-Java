 ...
 * <p>
 * Una clase abstracta no se puede instanciar directamente (no existe "una
 * figura genérica" en el mundo real, solo círculos, rectángulos, etc.). Lo que
 * SÍ hace es obligar a sus hijas a implementar ciertos métodos, y les regala
 * comportamiento común ya hecho (como describir()).
 */
public abstract class Figura {
	...
	public void describir() {
		System.out.printf("%s -> área: %.2f, perímetro: %.2f%n", nombre, calcularArea(), calcularPerimetro());
	}
