 ...
 * <p>
 * - "es un tipo de" Figura -> herencia, solo puede extender UNA clase. - "sabe
 * imprimir su ficha" -> Imprimible. - "sabe compararse con otro círculo" ->
 * Comparable&lt;CirculoImprimible&gt;.
 * <p>
 * IMPORTANTE: esto es exactamente lo que NO se puede hacer solo con clases
 * abstractas, porque Java tiene herencia simple (una sola clase padre). Con
 * interfaces, en cambio, se pueden firmar tantos contratos como se necesite.
 */
